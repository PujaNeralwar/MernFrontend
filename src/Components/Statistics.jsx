    ...
    const fetchData = async () => {
      try {
        ...
        const [customersResponse, booksResponse, buyingResponse] =
          await Promise.all([
            axios.get("https://backend-mgcr.onrender.com/customers", {
              headers: {
                Authorization: `Bearer ${token}`,
              },
            }),
            axios.get("https://backend-mgcr.onrender.com/books", {
              headers: {
                Authorization: `Bearer ${token}`,
              },
            }),
            axios.get("https://backend-mgcr.onrender.com/buyingmodules", {
              headers: {
                Authorization: `Bearer ${token}`,
              },
            }),
