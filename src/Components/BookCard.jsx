...
const BookCard = ({ book, token, isExpanded, onExpand, onRemove }) => {
  ...
  useEffect(() => {
    const checkIfFavorite = async () => {
      ...
      try {
        const response = await axios.get("https://backend-mgcr.onrender.com/wishlist", {
          headers: {
  ...
  const handleFavoriteClick = async () => {
    ...
    try {
      if (!isFavorite) {
        await axios.put(
          "https://backend-mgcr.onrender.com/wishlist",
        ...
        await axios.delete("https://backend-mgcr.onrender.com/wishlist", {
          headers: {
            Authorization: `Bearer ${token}`,
          },
          data: {
  ...
  const handleBuyNowClick = async () => {
    ...
    try {
      const response = await axios.get(
        `https://backend-mgcr.onrender.com/user/address/${userEmail}`,
        {
          headers: {
            Authorization: `Bearer ${token}`,
          },
  ...
  const handleBuyConfirm = async () => {
    try {
      ...
      const response = await axios.post(
        "https://backend-mgcr.onrender.com/purchase",
        {
